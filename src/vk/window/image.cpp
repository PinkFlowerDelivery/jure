...
jure::vk::window::DepthImageContext jure::vk::window::createImage(VkPhysicalDevice physicalDevice,
                                                                  VkDevice device,
                                                                  const VkExtent2D extent) {
    jure::vk::window::DepthImageContext imageContext;

    imageContext.format = findSupportedDepthFormat(
        physicalDevice,
